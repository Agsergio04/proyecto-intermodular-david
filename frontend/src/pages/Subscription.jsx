...
/**
 * @fileoverview Subscription management page.
 * Displays Free and Premium plans with features, supports upgrade/cancel flows
 * and handles the user's current subscription state.
 *
 * Integrations:
 * - `subscriptionService.getSubscription()` to fetch current plan
 * - `subscriptionService.createPayment()` to initiate payment flows
 * - `subscriptionService.cancelSubscription()` to cancel a plan
 *
 * @returns {JSX.Element} Full subscription plans UI.
 */
const Subscription = () => {
